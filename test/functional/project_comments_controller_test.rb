...
class ProjectCommentsControllerTest < ActionController::TestCase
  ...
  test "should create project_comment" do
    assert_difference('ProjectComment.count') do
      post :create, project_comment: { body: @project_comment.body, project_id: @project_comment.project_id, username: @project_comment.username }
    end
  ...
  test "should update project_comment" do
    put :update, id: @project_comment, project_comment: { body: @project_comment.body, project_id: @project_comment.project_id, username: @project_comment.username }
    assert_redirected_to project_comment_path(assigns(:project_comment))
  end
